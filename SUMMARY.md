...
* [服务器端模板注入](2-advanced-topics/1-server-side-template-injection.md)
* [Web缓存中毒](2-advanced-topics/2-web-cache-poisoning.md)
* [HTTP主机头攻击](2-advanced-topics/3-host-header.md)
* [HTTP请求走私](2-advanced-topics/4-request-smuggling.md)
* [OAuth认证](2-advanced-topics/5-oauth.md)
